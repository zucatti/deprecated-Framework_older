...
function using(b,cb) {
	...
	var sequelize_connection = new Sequelize('mysql://root:root@127.0.0.1:3311/sequelize');
	var bpclight = require('sequelize-import')(PROJECT_HOME+path.sep+'src'+path.sep+'Contents'+path.sep+'Db'+path.sep+'bpclight.scheme',sequelize_connection);	
	//bpclight.agents.belongsTo(bpclight.agents.subdis);
	sequelize_connection.sync({force: true});
};
